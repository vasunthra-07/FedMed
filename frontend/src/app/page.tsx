...
import { ClipboardList, Network, ShieldCheck, Stethoscope } from "lucide-react";
...
export default function LoginPage() {
  ...
  function onSubmit() {
    ...
    // Submitting takes you to the MedX overview instead of authenticating.
    router.push("/home");
  }

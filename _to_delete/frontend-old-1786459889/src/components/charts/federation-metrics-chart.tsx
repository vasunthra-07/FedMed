...
import { CATEGORICAL_PALETTE, STATUS_COLORS } from "@/lib/chart-colors";
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={chartData} margin={{ top: 4, right: 16, left: -8, bottom: 0 }}>
          ...
          <Bar yAxisId="left" dataKey="acceptedUpdates" name="Accepted updates" fill={STATUS_COLORS.success} radius={[3, 3, 0, 0]} />
          <Bar yAxisId="left" dataKey="rejectedUpdates" name="Rejected updates" fill={STATUS_COLORS.danger} radius={[3, 3, 0, 0]} />
